...
int main(void)
{
	...
	//RCC
	//Konfiguracja MCO - sygna³  dzielony przez 2, Ÿród³o MSI
	//RCC -> CFGR |= (RCC_CFGR_MCOPRE_DIV2);
	RCC -> CFGR |= (RCC_CFGR_MCOSEL_1); //MSI on MCO

	//MSI 2MHz
	//Czêstotliwoœc pracy MSI ustawiona na 2MHz
	...
	//PLL
	//Konfiguracja PLL do pracy z maksymaln¹ czêstotliwoœci¹
	...
	//Ustawienie dzielnika czêstotliwosci
